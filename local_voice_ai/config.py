...
class Config:
    ...
    #llama_model_path: str = "C:\\BizzHack\\models\\Qwen3-4B-Instruct-2507-Q8_0.gguf"
    ...
    # --- Interview database (PostgreSQL) ----------------------------------
    # Holds the candidates table: uid, status, JD text, resume text.
